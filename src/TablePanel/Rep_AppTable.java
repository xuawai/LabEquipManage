...
public class Rep_AppTable extends JTable{
 //JTable表分页信息相关变量
 ...
 //JTable表信息相关变量
 public List<Rep_App> Rep_Apps=Rep_App.Rep_Apps;
 public String[] columnNames={"Rep_App_ID","Lab_ID","Equipment_ID","Rep_App_Date","Rep_App_Price","Rep_App_Status"};
 public DefaultTableModel model=null;
 public Rep_AppTable(){initTable();}
 /**
  * 获取下一页
  */
  ...
  * @return
  */
 public Object[][] getData(List<Rep_App> Rep_Apps){
  if(Rep_Apps.size()>0){
   Object[][] data=new Object[Rep_Apps.size()][6];
   for(int i=0;i<Rep_Apps.size();i++){
	   Rep_App s=Rep_Apps.get(i);
    Object[] a={s.getRep_App_Id(),s.getLab_Id(),s.getEquipment_Id(),s.getRep_App_Date(),s.getRep_App_Price(),s.getRep_App_Status()};//把List集合的数据赋给Object数组
