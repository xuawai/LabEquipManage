...
public class Scrap_AppTableTest extends JPanel implements ActionListener {
 ...
 public Scrap_AppTableTest(int LABID) throws ClassNotFoundException, SQLException{
  this.LABID = LABID;
  initTableData();
  initComponent();
