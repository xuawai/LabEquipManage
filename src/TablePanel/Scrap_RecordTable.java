...
public class Scrap_RecordTable extends JTable{
 //JTable表分页信息相关变量
 ...
 //JTable表信息相关变量
 public List<Scrap_Record> Scrap_Records=Scrap_Record.Scrap_Records;
 public String[] columnNames={"scrap_id","lab_id","equipment_id","scrap_date"};
 public DefaultTableModel model=null;
 public Scrap_RecordTable(){initTable();}
 /**
  * 获取下一页
  */
  ...
  * @return
  */
 public Object[][] getData(List<Scrap_Record> Scrap_Records){
  if(Scrap_Records.size()>0){
   Object[][] data=new Object[Scrap_Records.size()][4];
   for(int i=0;i<Scrap_Records.size();i++){
	   Scrap_Record s=Scrap_Records.get(i);
    Object[] a={s.getScrap_id(),s.getLab_id(),s.getEquipment_id(),s.getScrap_date()};//把List集合的数据赋给Object数组
 ...
 public void initTable(){
  Object[][] data=getData(Scrap_Records);
  if(data!=null){
   initResultData(data);
