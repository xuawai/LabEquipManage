...
public class LabTable extends JTable{
 //JTable表分页信息相关变量
 ...
 //JTable表信息相关变量
 public List<Lab> Labs=Lab.Labs;
 public String[] columnNames={"Lab_Id","Lab_Name"};
 public DefaultTableModel model=null;
 public LabTable(){initTable();}
 /**
  * 获取下一页
  */
  ...
  * @return
  */
 public Object[][] getData(List<Lab> Labs){
  if(Labs.size()>0){
   Object[][] data=new Object[Labs.size()][2];
   for(int i=0;i<Labs.size();i++){
	   Lab s=Labs.get(i);
    Object[] a={s.getLab_Id(),s.getLab_Name()};//把List集合的数据赋给Object数组
