...
public class Rep_RecordTable extends JTable{
 //JTable表分页信息相关变量
 ...
 //JTable表信息相关变量
 public List<Rep_Record> Rep_Records=Rep_Record.Rep_Records;
 public String[] columnNames={"Rep_Record_ID","Lab_ID","Equipment_ID","Rep_Start_Date","Rep_End_Date","Rep_Price"};
 public DefaultTableModel model=null;
 public Rep_RecordTable(){initTable();}
 /**
  * 获取下一页
  */
  ...
  * @return
  */
 public Object[][] getData(List<Rep_Record> Rep_Records){
  if(Rep_Records.size()>0){
   Object[][] data=new Object[Rep_Records.size()][6];
   for(int i=0;i<Rep_Records.size();i++){
	   Rep_Record s=Rep_Records.get(i);
    Object[] a={s.getRep_Record_Id(),s.getLab_Id(),s.getEquipment_Id(),s.getRep_Start_Date(),s.getRep_End_Date(),s.getRep_Price()};//把List集合的数据赋给Object数组
 ...
 public void initTable(){
  Object[][] data=getData(Rep_Records);
  if(data!=null){
   initResultData(data);
