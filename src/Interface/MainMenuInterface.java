...
public class MainMenuInterface extends JFrame {
	...
	JButton exit,relogin,bt1,bt2,bt3,bt4,bt5;
	ImageIcon background;
	EquipmentTableTest equipmentTableTest;
	Rep_AppTableTest rep_AppTableTest;
	Rep_RecordTableTest rep_RecordTableTest;
	Pur_AppTableTest pur_AppTableTest;
	Pur_RecordTableTest pur_RecordTableTest;
	Scrap_AppTableTest scrap_AppTableTest;
	Scrap_RecordTableTest scrap_RecordTableTest;
	Borrowed_EquipmentTableTest borrowed_EquipmentTableTest;
	InRepTableTest inRepTableTest;
	public MainMenuInterface(String name,int LabId){
		this.LabId = LabId;
        ...
        bt1.addActionListener (new ActionListener() {    //产看实验设备块
            ...
            public void actionPerformed(ActionEvent e){      
            	update();
				try {
					equipmentTableTest = new EquipmentTableTest(LabId);
        ...
        bt2.addActionListener (new ActionListener() {    //采购实验设备块
            ...
            public void actionPerformed(ActionEvent e){      
				...
				try {
					pur_AppTableTest = new Pur_AppTableTest(LabId);
        ...
        bt4.addActionListener (new ActionListener() {    //报废实验设备块
            ...
            public void actionPerformed(ActionEvent e){      
				...
				try {
					scrap_AppTableTest = new Scrap_AppTableTest(LabId);
